...
require (
	...
	github.com/go-openapi/swag/jsonname v0.25.3
	github.com/go-openapi/swag/jsonutils v0.25.3
	github.com/go-openapi/swag/loading v0.25.3
	github.com/go-openapi/swag/mangling v0.25.3
	github.com/go-openapi/swag/netutils v0.25.3
